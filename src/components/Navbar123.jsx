...
import { faPhone, faEnvelope, faLocationDot, faBars, faXmark, faAngleDown } from '@fortawesome/free-solid-svg-icons';
...
const Navbar = () => {
    ...
    const loginForm = () => alert("Coming Soon!!");
        ...
        <div>
            ...
            <div className="topNav">
                <div className="container">
                    <div className="contact-left">
                        <p><FontAwesomeIcon className='icon' icon={faPhone} /><span>023691317/970637558</span></p>
                        <p><FontAwesomeIcon className='icon' icon={faEnvelope} /><span>info.libertysscollege@gmail.com</span></p>
                        <p><FontAwesomeIcon className='icon' icon={faLocationDot} /><span>Purano Bhadrapur road, Birtamode-5, Jhapa</span></p>
                    </div>
                    <div className="loginBtn">
                        <button className='enquiry'><NavLink to='/enquiry'>Enquiry</NavLink></button>
            ...
            <div className="navItems">
                <div className="navLogo">
                    <NavLink to="/">
                        <img src={navlogo} alt="Liberty SS/College Logo" />
                    </NavLink>
                </div>
